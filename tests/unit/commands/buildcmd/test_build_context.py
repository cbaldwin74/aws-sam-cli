...
class TestBuildContext__enter__(TestCase):
    @patch("samcli.commands.build.build_context.SamBuildableStackProvider.get_buildable_stacks_recursively")
    ...
    def test_must_setup_context(
        ...
        get_buildable_stacks_recursively_mock,
    ):
        template_dict = "template dict"
        stack = Mock()
        stack.template_dict = template_dict
        get_buildable_stacks_recursively_mock.return_value = [stack]
        ...
        get_buildable_stacks_recursively_mock.assert_called_once_with(
