...
def _function_build_definition_to_toml_table(
    ...
    toml_table[FUNCTIONS_FIELD] = [f.build_identifier for f in function_build_definition.functions]
...
def _layer_build_definition_to_toml_table(layer_build_definition: "LayerBuildDefinition") -> tomlkit.items.Table:
    ...
    toml_table[LAYER_FIELD] = layer_build_definition.layer.build_identifier
...
class FunctionBuildDefinition(AbstractBuildDefinition):
    ...
    def get_function_build_identifier(self) -> str:
        """
        Return the directory path relative to root build directory
        """
        self._validate_functions()
        return self.functions[0].build_identifier
